...
namespace yf
{
	Quatf::Quatf(float inX, float inY, float inZ, float inW)
	{
		x = inX;
		y = inY;
		z = inZ;
	...
	void Quatf::Set(float inX, float inY, float inZ, float inW)
	{
		x = inX;
		y = inY;
		z = inZ;
	...
	Quatf EulerToQuaternion(const Vec3f& someEulerAngles)
	{
